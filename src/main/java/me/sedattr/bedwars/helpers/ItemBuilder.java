...
public class ItemBuilder {
    ...
    public ItemBuilder(PotionType type, int amount, int level) {
        is = new Potion(type, level).toItemStack(amount);
    }
    /**
